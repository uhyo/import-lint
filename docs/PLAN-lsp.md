...
> **Archived (2026-07-16).** This plan is fully implemented (L1–L4: LSP server,
> VS Code extension, Marketplace/Open VSX publishing).
> The current plan is [docs/PLAN.md](./PLAN.md).
